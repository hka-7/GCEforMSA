...
from config import MOSI_PKL_PATH, MOSI_CSV_PATH, MOSEI_PKL_PATH, MOSEI_CSV_PATH
...
class MOSI:
    def __init__(self, config):
        ...
        try:
            ...
            pickle_filename = MOSI_PKL_PATH
            csv_filename = MOSI_CSV_PATH
...
class MOSEI:
    def __init__(self, config):
        ...
        try:
            ...
            pickle_filename = MOSEI_PKL_PATH
            csv_filename = MOSEI_CSV_PATH
